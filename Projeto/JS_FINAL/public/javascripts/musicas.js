...
$(document).ready(function() {
    ...
    function normal() {
        playlist = []
        $("#criar-div").empty()
        $("#criar-div").append('<button id="criar"> Criar Playlist')
        $("#criar-div").append('<button id="apagar"> Apagar Musicas')
        $(".botao-playlist").hide()
        $(".botao-apagar").hide()
        $(".botao-favorito").show()
        $.ajax({
    ...
    $("body").on('click', '#apagar', function () {
        ...
        $("#criar-div").append('<button id="confirmar"> Confirmar')
        $("#criar-div").append('<button id="cancelar"> Cancelar')
        $(".botao-playlist").hide()
        $(".botao-favorito").hide()
        if (tipo == "admin") {
            $(".botao-apagar").show()
    ...
    $("body").on('click', '#criar', function () {
        ...
        `)
        $("#criar-div").append('<button id="gravar"> Gravar')
        $("#criar-div").append('<button id="cancelar"> Cancelar')
        $(".botao-playlist").show()
        $(".botao-favorito").hide()
    })
