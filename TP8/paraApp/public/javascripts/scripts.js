...
var adicionar = '<button class="w3-button w3-round w3-red w3-hover-white" id="adicionarPara">Adicionar</button>'
    ...
    $.get("http://localhost:4000/para",dados => {
        dados.forEach(p => {
            var item = `<div class="li-item row">
                ...
                <div class="column">
                    <button class="w3-right w3-button w3-round w3-red w3-hover-white" id="editarPara" onclick="editar('${p._id}','${p.para}')">Editar</button>
...
function editar(id,para) {
    ...
    $('#paraText').val(para);
    $("#metodo").empty()
    $("#metodo").append(`<button class="w3-button w3-round w3-red w3-hover-white" id="atualizarPara" value=${id}>Atualizar</button>`)
}
...
$(function() {
    ...
    //$("body").on('click', '#editarPara', (x,y) => {
    //    event.preventDefault()
    //    console.log(x,y)
    //    //console.log(partes[1])
    //    //$('#paraText').val(partes[0]);
    //    //$("#metodo").empty()
    //    //$("#metodo").append(`<button class="w3-btn w3-red w3-margin-top" id="atualizarPara" value=${partes[1]}>Atualizar</button>`)
    //})
